...
<div style={{ borderRadius: "16px", overflow: "hidden", border: "1px solid rgba(128,128,128,0.25)" }}>
  <iframe src="https://www.tella.tv/video/aprenda-a-utilizar-a-aba-de-monitoramento-de-cadencia-3qyr/embed" style={{ width: "100%", aspectRatio: "16 / 9", border: "none", display: "block" }} allowfullscreen />
</div>
